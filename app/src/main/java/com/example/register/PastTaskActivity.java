...
public class PastTaskActivity extends AppCompatActivity {
    ...
    public void buildrecylerview() {
        ...
        mAdapter.setOnItemClickListener(new Exampleadapter.OnItemClickListener() {
            ...
            public void onitemclick(int position) {
                Intent intent = new Intent(com.example.register.PastTaskActivity.this, Popup.class);
    ...
    public void clearpasttask(View view) {
        AlertDialog.Builder dialog = new AlertDialog.Builder(com.example.register.PastTaskActivity.this);
