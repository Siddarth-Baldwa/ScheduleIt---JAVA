...
public class ProfileActivity extends AppCompatActivity {
    ...
    public void signout() {
        ...
        finish();
        Intent intent = new Intent(com.example.register.ProfileActivity.this, Login.class);
    ...
    public void deleteprofile() {
        AlertDialog.Builder dialog = new AlertDialog.Builder(com.example.register.ProfileActivity.this);
