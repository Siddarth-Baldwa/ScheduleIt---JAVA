...
public class SettingActivity extends AppCompatActivity {
    ...
    public void onProfile(View v) {
        Intent intent = new Intent(com.example.register.SettingActivity.this, ProfileActivity.class);
    ...
    private void resetDefault() {
        AlertDialog.Builder dialog = new AlertDialog.Builder(com.example.register.SettingActivity.this);
